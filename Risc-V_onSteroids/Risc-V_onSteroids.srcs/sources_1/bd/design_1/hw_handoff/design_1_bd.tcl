...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {105.000} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins myip_0/INSTR_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins myip_0/DATA_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins myip_0/REGS_AXI] [get_bd_intf_pins smartconnect_0/M02_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins myip_0/riscv_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins myip_0/data_axi_aclk] [get_bd_pins myip_0/instr_axi_aclk] [get_bd_pins myip_0/regs_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins myip_0/data_axi_aresetn] [get_bd_pins myip_0/instr_axi_aresetn] [get_bd_pins myip_0/regs_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset_rtl] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x4A001000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_0/DATA_AXI/DATA_AXI_reg] SEG_myip_0_DATA_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0x4A000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_0/INSTR_AXI/INSTR_AXI_reg] SEG_myip_0_INSTR_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0x4A002000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_0/REGS_AXI/REGS_AXI_reg] SEG_myip_0_REGS_AXI_reg
